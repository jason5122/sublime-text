...
class ExecCommand(sublime_plugin.WindowCommand, ProcessListener):
    ...
    def run(
        ...
        **kwargs
        ...
        self.quiet = quiet
        self.hide_after_success = hide_after_success
        ...
        preferences_settings = sublime.load_settings(
            "Preferences.sublime-settings"
        )
        show_panel_on_build = preferences_settings.get(
        ...
        self.show_errors_inline = preferences_settings.get(
    ...
    def on_finished(self, proc):
        ...
        is_success = exit_code == 0 or exit_code is None
        ...
        if self.hide_after_success and is_success:
            sublime.set_timeout(
                self.hide_build_results, self.HIDE_AFTER_SUCCESS_DELAY
            )
        ...
        for file, errs in self.errs_by_file.items():
            ...
            if view:
                ...
                for line, column, text in errs:
                    ...
                    if (
                        line_err_set
                        and line == line_err_set[len(line_err_set) - 1][0]
                    ):
                        line_err_set[len(line_err_set) - 1][
                            1
